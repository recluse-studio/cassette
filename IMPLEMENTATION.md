...
steps:
  ...
  - id: S13
    ...
    acceptance_boundary: "S13 receives structurally valid S12 records and independently recomputes their mathematical claims from canonical source evidence. Each listed contradiction must terminate before schedule admission. This remediation assigns the obligations only; S13 code and fixtures do not exist yet."
    expected_size: large
    done_when: full suite + ledger green
    depends: [S12]
    status: TODO
